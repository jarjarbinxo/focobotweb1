...
export default function Footer({ lang, onToggleLang }: FooterProps) {
  ...
  return (
    <footer className="bg-[#f9f8f6] border-t border-gray-100 py-12 px-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        {/* Left: logo + tagline */}
        <div className="flex flex-col items-center md:items-start gap-2">
          <div className="text-xl font-black">
            <span className="text-gray-900">FOCO</span><span className="text-orange">BOT</span>
          </div>
        ...
        {/* Right: social icons + lang toggle */}
